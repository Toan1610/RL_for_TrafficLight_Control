...
class MaxPressureConfig:
    ...
    cycling: str = "linear"
    max_delta_green: int = 5
    default_no_signal: int = 0
    ...
    @classmethod
    def from_params(cls, **params: Any) -> 'MaxPressureConfig':
        """Create MaxPressureConfig from parameter dictionary"""
        ...
        max_delta_green = params.get("max_delta_green", 5)
        default_no_signal = params.get("default_no_signal", 0)
        ...
        return cls(
            ...
            cycling=cycling,
            max_delta_green=int(max_delta_green),
            default_no_signal=int(default_no_signal),
        )
